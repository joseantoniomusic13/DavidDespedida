...
const RETOS_POR_RONDA = {
    ...
    ronda2: [
        ...
        { texto: "Celebra cada impacto como si hubieras marcado un gol en la final.", emoji: "⚽", color: "#f59e0b" },
    ...
    ronda3: [
        ...
        { texto: "El grupo elige una palabra prohibida. Si la dices, chupito 🥃", emoji: "🥃", color: "#f59e0b" },
    ...
    ultimaRonda: [
        ...
        { texto: "Te pones las uñas postizas que lleva Lorena y las llevas 30 minutos 💅", emoji: "💅", color: "#e11d48" },
        { texto: "Improvisa una coreografía en plena calle y aguanta 30 segundos sin parar 🕺", emoji: "💃", color: "#8b5cf6" },
        { texto: "Ronda de chupitos sin usar las manos — todos a la vez 🔥", emoji: "🔥", color: "#22d3ee" },
        ...
        { texto: "Bebe lo que tengas delante sin usar las manos 🍺", emoji: "🍺", color: "#f472b6" },
        { texto: "Habla con un acento que no sea el tuyo durante media hora 🗣️", emoji: "🎙️", color: "#60a5fa" },
        { texto: "¡Preguntas de cultura general! Demuestra que no eres un ignorante 🧠", emoji: "🧠", color: "#6366f1", quiz: true },
        { texto: "Haz una foto con 5 desconocidos en menos de 3 minutos 📸", emoji: "📸", color: "#e11d48" },
        { texto: "Publica una historia de Instagram diciendo cuánto quieres a Lorena 📱", emoji: "❤️", color: "#f59e0b" },
        { texto: "Pide una bebida en un bar hablando solo con mímica 🤐", emoji: "🍹", color: "#8b5cf6" },
        { texto: "Baila reguetón durante 1 minuto sin parar 💃", emoji: "🕺", color: "#22d3ee" },
        { texto: "Cuenta tu momento más vergonzoso delante de todos 😳", emoji: "🫣", color: "#34d399" },
        { texto: "Imita a tu suegra durante 2 minutos 😂", emoji: "🎭", color: "#f472b6" },
...
function seleccionarRonda(rondaKey) {
    ...
    const pass = prompt(`Introduce la contraseña secreta para acceder a esta ronda:`);
    if (pass === null) return; // Cancelado

    // Verificación (ignorando mayúsculas, minúsculas y espacios extra)
    if (pass.trim().toLowerCase() !== contrasenas[rondaKey].toLowerCase()) {
        alert("❌ Contraseña incorrecta. ¡Esa no toca ahora!");
        return;
    }
    ...
    textEl.textContent = textosTransicion[rondaKey];
    ...
    setTimeout(() => {
        ...
        rondaActual = rondaKey;
        localStorage.setItem('despedida_david_ronda', rondaKey);
...
// El jugador PUEDE hacer el reto → se marca como completado
